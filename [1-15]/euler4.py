"""
This script finds the largest palindrome product of two 3-digit numbers.
...
Example:
    Running the script will find and print the largest palindrome product of two 3-digit numbers,
    along with the pair of numbers that produce it.

Note:
    A palindrome is a number that remains the same when its digits are reversed.
    The script iterates through all possible products of two 3-digit numbers (ranging from 100 to 999),
    ...
    Finally, the maximum palindrome product and the corresponding pair of numbers are printed.
"""
